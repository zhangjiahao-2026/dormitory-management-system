...
ALTER TABLE visitor ADD COLUMN IF NOT EXISTS dormbuild_id INT;
ALTER TABLE visitor ADD COLUMN IF NOT EXISTS dormroom_id INT;
ALTER TABLE visitor ADD COLUMN IF NOT EXISTS registrar VARCHAR(50);
CREATE INDEX IF NOT EXISTS idx_visitor_build_time ON visitor (dormbuild_id, visit_time);
...
-- 访客记录
INSERT INTO visitor (name, gender, phone_num, origin_city, visit_time, content, dormbuild_id, dormroom_id, registrar) VALUES
('李女士', '女', '13600000001', '北京', '2026-05-24 10:00:00', '探望李同学并送生活用品', 1, 101, 'manager1'),
('赵先生', '男', '13600000002', '天津', '2026-05-23 15:30:00', '探望赵同学', 1, 101, 'manager1'),
('王女士', '女', '13600000003', '上海', '2026-05-22 09:20:00', '探望王同学', 2, 10101, 'manager2'),
('陈先生', '男', '13600000004', '南京', '2026-05-21 18:10:00', '送换季衣物', 1, 101, 'manager1'),
('周女士', '女', '13600000005', '杭州', '2026-05-20 11:45:00', '办理住宿材料确认', 1, 101, 'manager1'),
('吴先生', '男', '13600000006', '苏州', '2026-05-18 14:00:00', '探望吴同学', 1, 102, 'manager1'),
('孙女士', '女', '13600000007', '广州', '2026-05-17 16:25:00', '取回学生证件', 1, 102, 'manager1'),
('徐先生', '男', '13600000008', '深圳', '2026-05-15 13:35:00', '送学习资料', 1, 102, 'manager1'),
('胡女士', '女', '13600000009', '成都', '2026-05-12 10:50:00', '探望胡同学', 1, 102, 'manager1'),
('林先生', '男', '13600000010', '武汉', '2026-05-08 17:15:00', '毕业材料交接', 1, 103, 'manager1');
